    ...
    public FactoryTest InitFactory()
    {
        ...
        // 5.4
        {
            var items = new MInItems
            {
                ...
                DescriptionCase = "Успешная продажа табачной продукции (цена более 135 руб." +
                                  ...
                                  "групповая упаковка которых относится к временно не прослеживаемой (т.н. «серая зона»)"
            };
            _dictionary[items.Km] = items;
        }
        ...
        // 5.9
        {
            var items = new MInItems
            {
                ...
                IdCase = "5.9",
                DescriptionCase = "Успешная продажа блока сигарет (папирос) по максимальной розничной цене (цена более 135 руб. за пачку для соблюдения " +
        ...
        // 5.10
        {
            var items = new MInItems
            {
                ...
                IdCase = "5.10",
                DescriptionCase = "Продажа пачки сигарет (папирос) по максимальной розничной цене (цена до 100 руб. за пачку для прохождения на МГМ), указанной в коде маркировки"
            };
            _dictionary[items.Km] = items;
        }
        ...
        // 5.12
        {
            var items = new MInItems
            {
                ...
                IdCase = "5.12",
                DescriptionCase = "Продажа товара, сведения о маркировке средствами идентификации которого отсутствуют в информационной системе мониторинга"
            };
            _dictionary[items.Km] = items;
        }
        ...
        // 5.17
        {
            var items = new MInItems
            {
                ...
                IdCase = "5.17",
                DescriptionCase = "Продажа товара в режиме офлайн, отсутствующего в черном списке локального модуля."
            };
            _dictionary[items.Km] = items;
        }
        ...
        // 5.18
        {
            var items = new MInItems
            {
                ...
                IdCase = "5.18",
                DescriptionCase = "Продажа товара в режиме проверки офлайн, отсутствующего в черном списке ЛМ ЧЗ (ответ от ГИС МТ 5 секунд)"
            };
            _dictionary[items.Km] = items;
        }
